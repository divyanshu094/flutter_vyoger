...
Future<Null> selectDate(BuildContext context, DateTime first_date,
    ...
    {required Function(String) datevalue}) async {
      ...
      builder: (BuildContext context, Widget? child) {
        return Theme(
          data: ThemeData.light().copyWith(
            ...
            ).copyWith(secondary: AppConstants.APP_THEME_COLOR),
          ),
          child: child!,
        );
      },
...
Future<Null> selectDate2(BuildContext context, DateTime first_date,
    DateTime end_date, DateTime initalDate,
    {required Function(String) datevalue}) async {
  print('utill print ------- $first_date');
  final DateTime? picked = await showDatePicker(
      initialEntryMode: DatePickerEntryMode.calendarOnly,
      context: context,
...
openCustomCountryPickerDialog(BuildContext context,
        {required Function(Country) callback, required List<String> list}) =>
    showDialog(
      context: context,
      builder: (context) => Theme(
          data: Theme.of(context)
              .copyWith(primaryColor: AppConstants.APP_THEME_COLOR),
