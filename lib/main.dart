...
import 'package:mobility_sqr/Screens/ForgetPassScreen/ForgetPasswordViaMail.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetMaterialApp(
      ...
      routes: {
        ...
        '/ForgetPasswordViaMail': (context) => ForgetPasswordViaMail(),
        '/AddEmergencyContact': (context) => AddEmergencyContact()
      },
    );
  }
}
