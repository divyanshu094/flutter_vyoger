...
class TableCalendar extends StatefulWidget {
  ...
  TableCalendar({
    ...
    // this.calendarStyle = const CalendarStyle(markersPositionTop: 0, markersPositionLeft: 0, markersPositionRight: 0),
    // this.daysOfWeekStyle = const DaysOfWeekStyle(dowTextBuilder: (DateTime date, locale) {  }),
    // this.headerStyle = const HeaderStyle(titleTextBuilder: (DateTime date, locale) {  }, headerMargin: null),
