...
class CalendarBuilders {
  ...
  const CalendarBuilders({
    ...
    required this.selectedDayBuilder,
    required this.todayDayBuilder,
    required this.holidayDayBuilder,
    required this.weekendDayBuilder,
    required this.outsideDayBuilder,
    required this.outsideWeekendDayBuilder,
    required this.outsideHolidayDayBuilder,
    required this.unavailableDayBuilder,
    required this.markersBuilder,
    required this.singleMarkerBuilder,
    required this.dowWeekdayBuilder,
    required this.dowWeekendBuilder,
