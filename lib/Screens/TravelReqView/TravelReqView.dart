...
class _TravelReqViewState extends State<TravelReqView> {
  ...
  late SubmitRequestForApprovalModel body; //= SubmitRequestForApprovalModel();
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        list.details[index].travellingCountryTo,
                                        "To",
                                        1,
                                        true,
                                        onTap: () {},
                                  ...
                                  children: [
                                    Expanded(
                                      ...
                                      child: Container(
                                        ...
                                        "",
                                        getDepartureTime(
                                            list.details[index].departureDate),
                                        list.details[index].travellingCountry,
                                        "Departure",
                                        2,
                                        false,
                                  ...
                                  ? Column(
                                      children: [
                                        ...
                                        list.details[index].isDependent
                                            ? Column(
                                                children: setDependentsList(
                                                    list.dependent, index),
                                              )
                                            : SizedBox(),
                                      ],
                                    )
                                        ...
                                        child: FormField<Currency_Data>(
                                          builder:
                                            ...
                                            return InputDecorator(
                                                ...
                                                //         return _currencyConversiondata
                                                //             .map((Currency_Data
                                                //                 value) {
                                                //           return Text(
                                                //             '${totalCurrencyCode}',
                        ...
                        children: [
                          AutoSizeText("Name :",
                              ...
                              style: TextStyle(
                                  fontSize: 12,
                                  color: AppConstants.TEXT_BACKGROUND_COLOR)),
                          AutoSizeText("${dependent[i].dependentName}",
                              minFontSize: 5,
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 14,
                        ...
                        children: [
                          AutoSizeText("Relation: ",
                              ...
                              style: TextStyle(
                                  fontSize: 10,
                                  color: AppConstants.TEXT_BACKGROUND_COLOR)),
                          AutoSizeText("${dependent[i].dependentRelation}",
                              minFontSize: 5,
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 10,
...
SetVisaReqId(MyModelData list) {
  print('mobility travel requied 2');
  print(json.encode(list));
  String travelVisaReq = " ";
  if (list.visaRequests.length != 0) {
