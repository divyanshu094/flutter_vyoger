...
class AddNewTravel2State extends State<AddNewTravel2> {
  ...
  late String HomeCountryName;
  late TravelReqPayLoad list;
                        ...
                        child: TextButton(
                          ...
                          onPressed: () {
                            if (validator(list, context)) {
                              ...
                              list.travelVisa.addAll(
                                  GenerateVisa(list, info, HomeCountryName));
                              ...
                              list.expenceReturnDate =
                                  list.travelCity[0].returnDate;
                              ...
                              _appApiProvider.PostTravelRequest(jsonbody).then(
                                  (response) => handleNavigation(response));
                            } else {
                              showDefaultSnackbar(
...
GenerateVisa(TravelReqPayLoad mydata, UserInfo info, String homeCountryName) {
  ...
  List<TravelVisa> visalist = <TravelVisa>[];
  TravelVisa visa;
...
validator(TravelReqPayLoad list, context) {
  if (list.homeContactName.trim().isEmpty) {
    return false;
