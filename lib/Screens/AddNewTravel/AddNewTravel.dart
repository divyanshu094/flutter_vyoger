...
class _AddCity extends State<AddCity> {
  ...
  late PerDiemModel perDiemModel;
  List<dynamic> userdetails = [];
  List<TravelCity> traveldata = <TravelCity>[];
  int index = 0;
  int id = 1;
                    ...
                    Container(
                      ...
                      child: GestureDetector(
                        onTap: () async {
                          ...
                          ProjectTextController.text = project.projectName +
                              "(" +
                              project.pid.split('ORG')[0] +
                              ")";
                        },
                        child: TextFormField(
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    // print('new req data req_data.project ${req_data.project}');
                    // print('new req data required ${req_data.toJson()}');
                    // return;
    ...
    for (int i = 0; i < formdata.travelCity.length; i++) {
      ...
      if (HomeCountryName != formdata.travelCity[i].travellingCountryTo) {
        if (cityTravel.hostHrName.isEmpty) {
          ...
          if (cityTravel.officeLocation.isEmpty) {
            return false;
          }
        }
      }
...
GenerateVisa(TravelReqPayLoad mydata, UserInfo info, String homeCountryName) {
  ...
  for (int i = 0; i < mydata.travelCity.length; i++) {
    ...
    // if (!isHomeCountry) {
    //   if (!mydata.travelCity[i].hasVisa ||
    //       checkVisaApplicable(
