...
import '../../ModelClasses/UserToken.dart';
import '../../Widgets/ToastCustom.dart';
...
class _Username_Screen extends State<Username_Screen> {
  ...
  @override
  void dispose() {
    bloc.flush(); // call the dispose method to close our StreamController
    super.dispose();
  }
                            ...
                            builder: (context, AsyncSnapshot<UserToken> snapshot) {
                              ...
                              return ElevatedButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    FocusScope.of(context).unfocus();
                                    UserToken data =
                                        await bloc.passwordValidate(context);
                                    if (data.status) {}
