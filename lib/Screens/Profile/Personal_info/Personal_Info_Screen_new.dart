...
class _PersonalInfoState extends State<PersonalInfo> {
  ...
  editprofile() {
    var data = {
      "user_name": _userProfile.userName,
      "email": _userProfile.email,
      "first_name": _userProfile.firstName,
      "middle_name": _userProfile.middleName,
      "last_name": _userProfile.lastName,
      "country_of_birth": _userProfile.countryOfBirth,
    };
    print('edit profile data $data');
  }
                  ...
                  child: Column(
                    children: [
                      ...
                      ColumnWidget(
                        ...
                        iseditable,
                        true,
                        myText: _userProfile.countryOfBirth != null
                            ? _userProfile.countryOfBirth
                            : "",
                      ),
                      ColumnWidget(
                        'Marital Status',
                      ...
                      ColumnWidget(
                        ...
                        iseditable,
                        true,
                        myText: _userProfile.nationality,
                      ),
                      ColumnWidget(
                        'Supervisor',
                        'Search...',
                ...
                child: Center(
                  child: Container(
                    ...
                    child: TextButton(
                      ...
                      // ),
                      onPressed: () {
                        iseditable ? editprofile() : print('non editable');
