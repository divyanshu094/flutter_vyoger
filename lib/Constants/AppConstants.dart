...
//==============================================================================URL
  ...
  static final String BASE_URL = "https://oldapi.mobilitysqr.net"; //Prod Url
  // static final String BASE_URL = "http://mobilitysqr.net:8000"; //preprod Url
  // static final String BASE_URL = "http://172.105.35.73:3000"; //new db Url
  ...
  static final String GET_EMPLOYEE_PASSPORTFOR =
      "/getemployee_emergency_contact/";
  static final String POST_EMPLOYEE_PASSPORT = "/get_post_employee_passport/";
  static final String GET_EMPLOYEE_VISA = "/getemployee_visa_info/";
  static final String POST_EMPLOYEE_VISA = "/get_post_employee_visa/";
  ...
  static final String EDIT_EMPLOYEE_PROFILE = "/get_add/employee/";
  ...
  static final String COMPLIANCE_QUESTIONS = "/get_post_compliance_answer/";
  static final String COMPLIANCE_QUESTIONS_GET = "/get_post_compliance/";
  static final String GET_MARITAL = "/get_post_marital_status/";
  static final String GET_POST_GENDER = "/get_post_gender/";
  static final String GET_DIAL_CODE = "/get_dial_code/?dial_code=";
  static final String POST_EMERGENCY_CONTACT =
      "/get_add/employee_emergencycontact/";

  static final String BULK_APPROVAL = "/bulk_approve_travelvisa_request/";
...
//=========================================================================================Strings
  ...
  static const String FIRST_TIME = "isFirstTime";
}
