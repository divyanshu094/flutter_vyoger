...
class RadioBtn extends StatefulWidget {
  ...
  RadioBtn(@required this.item1, @required this.item2, @required this.id,
          ...
          child: Container(
            ...
            child: Container(
              ...
              child: AutoSizeText(
                widget.item2,
                style: widget.id == 2
                    ? TextStyle(color: AppConstants.APP_THEME_COLOR)
                    : TextStyle(color: AppConstants.TEXT_BACKGROUND_COLOR),
                minFontSize: 10,
                maxFontSize: 13,
              ),
            ),
