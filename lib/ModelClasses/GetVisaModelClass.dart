class GetVisaModel {
  ...
  late List<GetVisaModelData> _data;

  GetVisaModel({required bool status,required String message,required List<GetVisaModelData> data}) {
    this._status = status;
