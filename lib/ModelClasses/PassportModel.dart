class PassportModel {
  ...
  late bool _status;
  late List<PassportDetail> _data;

  PassportModel(
      {required String massage,
      required bool status,
      required List<PassportDetail> data}) {
...
class PassportDetail {
  ...
  late bool _status;
  late bool _passportStatus;
  late String _passportNumber;
  late String _passportExpiryDate;
  late bool _isdependent;
  late String _relation;
  late String _nationality;
  late String _countryOfIssue;
  late String _placeOfIssue;
  late String _dateOfIssue;
  late String _dateOfExpiration;
  late bool _duplicatePassport;
  late String _pagesPassport;
  late String _photo;
  ...
  PassportDetail(
      ...
      required String dateOfExpiration,
      required bool duplicatePassport,
      required String pagesPassport,
