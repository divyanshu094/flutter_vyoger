class EmergencyModel {
  ...
  late bool _status;
  late List<Datae> _data;

  EmergencyModel(
      {required String massage,
      required bool status,
      required List<Datae> data}) {
  ...
  List<Datae> get data => _data;

  set data(List<Datae> data) => _data = data;
  ...
  EmergencyModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['data'] != null) {
      _data = <Datae>[];
      json['data'].forEach((v) {
        _data.add(new Datae.fromJson(v));
      });
    }
  }
