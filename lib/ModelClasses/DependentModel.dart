...
class SecondDependentData {
  ...
  late bool _primaryFlag;
  late String _countryCode;
  late String _secondCountryCode;
  late String _phone;
  late String _secondPhone;
  late bool _isDependent;
  late bool _isEmergencyContact;
  late String _gender;
  late String _email;
  late bool _isAddSameAsEmployee;
  late String _address1;
  late String _address2;
  late String _address3;
  late String _city;
  late String _state;
  late Null _addressType;
  ...
  SecondDependentData(
      ...
      required bool primaryFlag,
      required String countryCode,
      required String secondCountryCode,
      ...
      required bool isAddSameAsEmployee,
      required String address1,
      required String address2,
      required String address3,
      required String city,
      required String state,
      required Null addressType,
  ...
  SecondDependentData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['emp_passport'] == "") {
      empPassport = json['emp_passport'] != null ? json['emp_passport'] : null;
    } else {
    ...
    if (json['emp_visa'] == "") {
      empVisa = json['emp_visa'] != null ? json['emp_visa'] : null;
    } else {
...
class EmpPassport {
  ...
  late bool status;
  late bool passportStatus;
  late String passportNumber;
  late String passportExpiryDate;
  ...
  late String dateOfExpiration;
  late bool duplicatePassport;
  late String pagesPassport;
  late String photo;
  late Null column1;
  late Null column2;
  late Null column3;
  ...
  EmpPassport(
      ...
      required this.duplicatePassport,
      required this.pagesPassport,
      required this.photo,
      this.column1,
      this.column2,
      this.column3,
