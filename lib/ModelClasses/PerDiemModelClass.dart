class PerDiemModelClass {
  ...
  late PerDiemModel _data;

  PerDiemModelClass(
      {required bool status,
      required String message,
      required PerDiemModel data}) {
    this._status = status;
  ...
  PerDiemModelClass.fromJson(Map<String, dynamic> json) {
    ...
    _data = (json['data'] != null
        ? new PerDiemModel.fromJson(json['data'])
        : null)!;
  }
...
class PerDiemModel {
  ...
  late String _perDiem;
  late String _accommodationLimit;
  ...
  PerDiemModel(
      ...
      required String perDiem,
      required String accommodationLimit,
